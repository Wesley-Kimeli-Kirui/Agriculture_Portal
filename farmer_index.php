...
<!-- Custom Theme files -->
<link href="css/style.css?<?php echo rand(); ?>" rel="stylesheet" type="text/css" media="all" />
<!-- Custom Theme files -->
	...
	<div class="header-banner">
		<div class="container">
			...
			<div class="header-top">
				<div class="social-icons">
					...
					function googleTranslateElementInit() {
						new google.translate.TranslateElement({pageLanguage: 'en', includedLanguages: 'swa,en,ki,hi'}, 'google_translate_element');
					}
					</script>
			...
			<div class="banner-info text-center">
				<h1><a href="farmer_index.php">Mkulima</a></h1>
			</div>
					...
					<div class="header-grids   text-center">
						...
						<div class="header-bottom-grid3">
							...
							<h4><a href="upcoming_days.php" style="color:white;">Weather Prediction </a></h4>
						</div>
