				...
				<form role="form"  id="buycrops"  method="POST" enctype="multipart/form-data">   
                    ...
                    <tr>
						...
						<select id="crops" name="crops">
  							<option value="pea">Pegion pea</option>
							...
							<option value="grams">Green Grams</option>
							<option value="ragi">Finger Millet</option>
  							<option value="rice">Rice</option>
							<option value="soyabean">Soyabean</option>
							<option value="grams">Black gram</option>
								...
								$TotalCartPrice=$_SESSION['Total_Cart_Price']*100;
											echo '
												...
												<script 
													...
													data-currency="inr"
													data-name="Mkulima Payment Portal"
