function tradecrops() {
    ...
    if(!crop.localeCompare("pegion pea")) {
    ...
    if(!crop.localeCompare("green grams")) {
    ...
    if(!crop.localeCompare("finger millet")) {
    ...
    if(!crop.localeCompare("black gram")) {
