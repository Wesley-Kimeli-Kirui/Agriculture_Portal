			...
			<div class="header-top">
				<div class="social-icons">
					...
					function googleTranslateElementInit() {
						new google.translate.TranslateElement({pageLanguage: 'en', includedLanguages: 'swa,en,ki,af,hi'}, 'google_translate_element');
					}
					</script>
	...
	<!-- header-section-ends -->    
                ...
                <table class="table table-striped table-bordered table-responsive-md btn-table">
                    ...
                    <tr>
						...
						<th>Cost borne by farmer per KG (in Ksh.)</th>
                    ...
                    <tr>
						...
						<select id="crops" name="crops">
  							<option value="arhar">Pegion pea</option>
							<option value="bajra">Pearl millet</option>  
							<option value="barley">Barley</option>
							<option value="cotton">Cotton</option>	
							<option value="gram">Gram</option>
							<option value="jowar">Sorghum</option>
							<option value="jute">Fibre</option>
							<option value="lentil">Lentil</option>
							<option value="maize">Maize</option>
							<option value="moong">Green grams</option>
							<option value="ragi">Finger millet</option>
  							<option value="rice">Rice</option>
							<option value="soyabean">Soyabean</option>
							<option value="urad">Black gram</option>
